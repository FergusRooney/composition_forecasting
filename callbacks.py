...
ANSRO_DF = pd.read_csv('/app/data/ANSRO_DF_dummy.csv', parse_dates=['date_time'], sep=';')
ANSRO_DD = pd.read_csv('/app/data/ANSRO_DD_dummy.csv', parse_dates=['date_time'], sep=";")
...
def update_output(list_of_contents,dropdownValue,nclicks,filenames,uploadData):
    ...
    if context[0]['prop_id'] == "Upload-Data-Button.n_clicks" and uploadData and dropdownValue != None:
        ...
        Name = "/app/data/" + dropdownValue +".csv"
...
def update_graph(n, net_point_choice): #load_type_choice is legacy, please remove
    ...
    dd_select = pd.read_csv('/app/data/MELTEMI_DD_dummy.csv', parse_dates=['date_time'], sep=";")
