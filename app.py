                    ...
                    children=[
                        dbc.Row(style={"width": "100%"}, children=[
                            ...
                            dbc.Col(width=6, style={"text-align": "end"}, children=[
                                dbc.Button("Tools", outline=True, color="secondary", className="mr-1",
                                           id="btn_sidebar"),
                                dbc.NavItem(dbc.NavLink("Home", href="/"), style={"display": "inline-block"}),
                                dbc.NavItem(dbc.NavLink("About Project", href="/about-project"),
                                            style={"display": "inline-block"}),
                                dbc.NavItem(dbc.NavLink("Further Development", href="/further-development"),
                                            style={"display": "inline-block"}),
