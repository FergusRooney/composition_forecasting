...
from components import left_pane, load_decomposition_chart, pie_chart_pane, image_selector_pane, explanation_tab, \
    ...
    dd_error_info_tab_P, dd_error_info_tab_Q, pie_chart_pane_P, pie_chart_pane_Q, upload_data, upload_dropdown, \
    upload_buttons, solar_forecast_pane, wind_forecast_pane, wind_solar_info_tab, forecast_button, train_button
        ...
        html.Div(className='main',
                 children=[
                     dbc.Row(children=[
                         ...
                         dbc.Col(children=[
                             forecast_button], width=2),
                         dbc.Col(children=[train_button], width=1),
                         ...
                         dbc.Row(
                             children=[dbc.Col(
                                 children=[
                                     ...
                                     dbc.Col(style={"max-width": 350},
                                             children=[upload_data, upload_dropdown, upload_buttons],
                                             ),
                                 ],
                                 className="panel",
                                 width=9
